    ...
    return (
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-2">
        {Array.from({ length: 10 }).map((_, i) => (
          <div
            key={i}
            className="h-11 rounded-xl shimmer-loading"
    ...
    return (
      <div className="flex flex-col items-center justify-center py-10 gap-3 text-gray-400">
        ...
        <div className="text-center">
          <p className="text-sm font-semibold text-gray-500">No clinic hours</p>
        ...
        return (
          <button
            ...
            className={`
              ...
              ${
                isSelected
                  ? "bg-primary text-white border-primary shadow-lg pulse-ring-primary"
                  : "bg-white text-primary border-primary/30 hover:bg-primary/8 hover:border-primary hover:shadow-md hover:-translate-y-0.5"
              }
            `}
          >
            <FaClock
