...
import { type Tab, TABS } from "../../types/admin";
...
export default function AdminDashboard() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-primary-dark">Admin overview</h1>
        <p className="text-primary-dark/60 text-sm">
          Platform health, doctor verification, and oversight.
        </p>
      </div>

      <div className="flex gap-1 border-b border-surface-variant overflow-x-auto">
        {TABS.map((tab) => (
          <button
            key={tab}
