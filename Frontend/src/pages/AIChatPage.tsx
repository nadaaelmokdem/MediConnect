                ...
                {recommendedDepts.length > 0 ? (
                  recommendedDepts.map(dept => (
                    <button 
                      ...
                      className="px-5 py-2.5 bg-primary text-white rounded-xl text-sm font-bold hover:bg-primary-dark transition-colors shadow-sm"
                    >
                      Find {dept} Doctor
                    </button>
                  ))
          ...
          <div className="bg-white p-6 rounded-2xl shadow-xl max-w-sm w-full border border-surface-variant">
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button 
                ...
                className="px-5 py-2.5 text-sm font-bold text-white bg-primary rounded-xl hover:bg-primary-dark transition-colors shadow-md"
              >
